...
from text_rnn_attention import TextRNN
...
tf.flags.DEFINE_string("model", "ATT-LSTM", "Type of classifiers. You have six choices: [LSTM, BiLSTM, LSTM-pool, BiLSTM-pool, ATT-LSTM, ATT-BiLSTM] (default: LSTM)")
